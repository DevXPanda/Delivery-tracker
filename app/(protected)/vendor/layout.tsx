...
import { Truck, Package, Home, Settings, Menu, X, LogOut, Bell } from 'lucide-react';
              ...
              <Sheet>
                ...
                <SheetContent side="right">
                  <div className="flex flex-col gap-4 mt-8">
                    ...
                    <Link href="/vendor/orders" className="flex items-center gap-2 py-2">
                      <Package className="h-5 w-5" />
                      <span>Orders</span>
                    </Link>
                    <Link href="/vendor/settings" className="flex items-center gap-2 py-2">
